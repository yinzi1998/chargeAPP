 ...
 */
public class ViewPg3Fragment extends Fragment {
    private static final String TAG = "ViewPg1Fragment";
    private String date;

    public ViewPg3Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_view_pg3, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        TextView tv_date = getView().findViewById(R.id.textView_viewpg3_date);
        TextView tv_money2 = getView().findViewById(R.id.textView_viewpg3_money2);
        TextView tv_chi3 = getView().findViewById(R.id.textView_viewpg3_chi3);
